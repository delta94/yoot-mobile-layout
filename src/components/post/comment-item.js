...
import { toggleCommentDrawer, toggleUserPageDrawer } from "../../actions/app";
...
class Index extends React.Component {
   ...
   render() {
      let { comment, hideReactions, profile, onReply, posted, image } = this.props
      let { openReactions } = this.state
                           ...
                           onClick={() => {
                              if (comment.idusercomment === profile.id) {
                                 ...
                                 this.props.setCurrenUserDetail({
                                    friendid: comment.idusercomment
                                 });
                                 this.props.toggleUserPageDrawer(true);
                              }
                           }}
                        >{comment.nameusercomment}</label>
                        <div>
                           {
                              content && content != "" ?
