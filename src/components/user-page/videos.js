...
export class Index extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.open == true) {
            if (videos.length == 0) this.getVideos(videosCurrentPage, currentUser.id)
        }
    }
                        ...
                        currentUser ? <div className="drawer-detail media-drawer">
                            <div className="drawer-header">
                                <div className="direction" onClick={() => this.props.onClose()}>
                                    ...
                                    <label>Video của {currentUser.fullname}</label>
                                </div>
                            </div>
                            <div className="filter">
                            </div>
                            <div className="content-form" style={{ overflow: "auto" }} id={"video-content-" + currentUser.id} onScroll={() => this.onScroll(currentUser.id)}>
